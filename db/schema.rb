...
ActiveRecord::Schema.define(version: 20181210021620) do
  ...
  create_table "arrival_types", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name"], name: "index_arrival_types_on_name", unique: true
  end

  create_table "babers", force: :cascade do |t|
  ...
  create_table "guest_froms", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name"], name: "index_guest_froms_on_name", unique: true
  end
